...
export const Dashboard: FC = () => {
  ...
  const [mainCardOrder, setMainCardOrder] =
    useState<string[]>(defaultMainCards);
  const [sidebarCardOrder, setSidebarCardOrder] =
    useState<string[]>(defaultSidebarCards);
  ...
  useEffect(() => {
    ...
    const savedSidebarOrder = localStorage.getItem(
      "dashboard-sidebar-card-order",
    );
            ...
            {isFocusMode ? (
              ...
              <>
                ...
                <DraggableCard
                  ...
                  onReorder={handleMainCardReorder}
                >
                ...
                {sidebarCardOrder.map((cardId) => {
                  ...
                  return card ? (
                    <DraggableCard
                      key={cardId}
                      id={cardId}
                      onReorder={handleSidebarCardReorder}
                    >
                      {card}
                    </DraggableCard>
                  ) : null;
