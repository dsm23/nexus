        ...
        <div className="space-y-1">
          ...
          <div className="flex items-center gap-1 text-xs sm:text-sm">
            {metric.changeType === "increase" ? (
              <TrendingUp className="size-3 text-green-600 sm:size-4" />
            ) : (
              <TrendingDown className="size-3 text-red-600 sm:size-4" />
            )}
            <span
              className={
                metric.changeType === "increase"
        ...
        <Tabs defaultValue="overview" className="space-y-6">
          ...
          <TabsContent value="overview" className="space-y-6">
            ...
            >
              {/* Activity Trends */}
              <Card
                className="animate-in duration-500 fade-in slide-in-from-left-4"
