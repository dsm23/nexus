  ...
  const handleResultClick = useCallback(
    async (result: SearchResult) => {
      ...
      if (result.searchParams) {
        for (const [key, value] of Object.entries(result.searchParams)) {
      ...
      await navigate(routeWithParams);
      setIsOpen(false);
      setSearchQuery("");
    },
    [navigate],
  ...
  return (
    <>
      ...
      >
        ...
        <div className="flex items-center gap-1 rounded-sm bg-muted px-1.5 py-0.5 text-xs">
