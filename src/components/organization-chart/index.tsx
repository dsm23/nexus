...
const getHierarchyLevel = (role: string): number => {
  ...
  if (lowerRole.includes("ceo") || lowerRole.includes("chief executive"))
    return 0;
  if (
          ...
          <div className="flex flex-col items-center space-y-3 text-center">
            <div className="relative">
              <img
                src={employee.avatar}
                alt={employee.name}
                className="size-16 rounded-full border-2 border-background bg-muted shadow-sm"
              />
              <div
                className={`absolute -right-1 -bottom-1 flex size-6 items-center justify-center rounded-full text-xs ${
                  level === 0
            ...
            <div className="w-full space-y-2">
              ...
              <p className="line-clamp-2 text-xs/tight text-muted-foreground">
                {employee.role}
              </p>
              <Badge
                variant="outline"
              ...
              >
                ...
                >
                  <Tree
                    ...
                    label={
                      <EmployeeNode
                        employee={orgHierarchy.employee}
                        isRoot={true}
                      />
                    }
                  >
          ...
          <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
            ...
            <div className="flex items-center gap-2">
              <div className="flex size-6 items-center justify-center rounded-full bg-blue-500">
                <Shield className="size-3 text-blue-50" />
              </div>
              <span className="text-sm">Director / VP</span>
            </div>
            <div className="flex items-center gap-2">
              <div className="flex size-6 items-center justify-center rounded-full bg-gray-500">
                <Users className="size-3 text-gray-50" />
              </div>
              <span className="text-sm">Manager / Lead</span>
            </div>
            <div className="flex items-center gap-2">
              <div className="flex size-6 items-center justify-center rounded-full bg-gray-500">
                <User className="size-3 text-gray-50" />
              </div>
