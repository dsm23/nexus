...
const Tabs: FunctionComponent<TabsPrimitive.Root.Props> = ({
  className,
...
const TabsTrigger: FunctionComponent<TabsPrimitive.Tab.Props> = ({
  className,
  ...props
}) => (
  <TabsPrimitive.Tab
...
const TabsContent: FunctionComponent<TabsPrimitive.Panel.Props> = ({
  className,
  ...props
}) => (
  <TabsPrimitive.Panel
