...
const SelectGroup: FunctionComponent<SelectPrimitive.Group.Props> = ({
  className,
  ...props
}) => (
...
const SelectValue: FunctionComponent<SelectPrimitive.Value.Props> = ({
  className,
  ...props
}) => (
...
const SelectLabel: FunctionComponent<SelectPrimitive.GroupLabel.Props> = ({
  className,
  ...props
}) => (
...
const SelectItem: FunctionComponent<SelectPrimitive.Item.Props> = ({
  className,
  children,
  ...props
}) => (
...
const SelectSeparator: FunctionComponent<SelectPrimitive.Separator.Props> = ({
  className,
  ...props
}) => (
