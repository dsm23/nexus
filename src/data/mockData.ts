...
export const kudos: Kudo[] = [
  {
    ...
    to: "Priya Sharma",
    message:
      "Amazing work on the new dashboard components! The attention to detail is fantastic.",
  ...
  },
  {
    ...
    to: "Alex Thompson",
    message:
      "Thanks for staying late to fix the deployment issues. You saved the day!",
...
export const projects: Project[] = [
  {
    ...
    description:
      "Redesign the employee onboarding process with digital workflows and automated paperwork to improve the new hire experience.",
    status: "active",
    priority: "high",
    progress: 65,
    ...
    tasks: [
      {
        ...
        description:
          "Map out the complete onboarding process from offer acceptance to first day",
        status: "completed",
        priority: "high",
      ...
      },
      {
        ...
        description:
          "Create user-friendly digital forms to replace paper documentation",
        status: "in-progress",
        priority: "medium",
  ...
  },
  {
    ...
    description:
      "Implement a comprehensive performance review system with 360-degree feedback, goal tracking, and development planning.",
    status: "active",
    priority: "medium",
    progress: 30,
  ...
  },
  {
    ...
    description:
      "Analyze and optimize office layout for better collaboration, productivity, and employee satisfaction.",
    status: "completed",
    priority: "low",
    progress: 100,
  ...
  },
  {
    ...
    description:
      "Update company remote work policies to reflect post-pandemic work arrangements and hybrid schedules.",
    status: "on-hold",
    priority: "medium",
    progress: 45,
  ...
  },
  {
    ...
    description:
      "Upgrade company-wide security infrastructure including multi-factor authentication and endpoint protection.",
    status: "active",
    priority: "high",
    progress: 80,
    startDate: new Date(2025, 6, 1), // July 1, 2025
...
export const helpdeskTickets: HelpdeskTicket[] = [
  {
    ...
    description:
      "I'm unable to log into my email account. Getting authentication errors.",
    category: "access",
    priority: "high",
    status: "in-progress",
  ...
  },
  {
    ...
    description:
      "My laptop has been extremely slow for the past week. Takes forever to open applications.",
    category: "hardware",
    priority: "medium",
    status: "open",
  ...
  },
  {
    ...
    description:
      "The printer in Conference Room B is not responding to print jobs.",
    category: "hardware",
    priority: "low",
    status: "resolved",
  ...
  },
  {
    ...
    description:
      "Adobe Creative Suite license has expired and I need access for a project.",
    category: "software",
    priority: "urgent",
    status: "in-progress",
  ...
  },
  {
    ...
    description:
      "I need VPN access to work remotely. Please set up access for my account.",
    category: "access",
    priority: "medium",
    status: "closed",
